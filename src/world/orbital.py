...
class Orbital:
    ...
    def compute(self, dt: datetime) -> OrbitalState:
        ...
        return OrbitalState(
            ...
            orbital_position_deg=round(ecliptic_lon, 2),
            true_anomaly_deg=round(true_anomaly_deg_val, 2),
            mean_anomaly_deg=round(mean_anomaly_deg, 2),
            orbital_speed_kms=round(v_kms, 3),
            axial_tilt_deg=round(obliquity_deg, 4),
            solar_declination_deg=round(solar_decl, 2),
            season=season,
